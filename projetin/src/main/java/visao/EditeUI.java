...
public class EditeUI extends JFrame {
    ...
    public EditeUI() {
        ...
        JLabel lblAdicioneSeuGalo = new JLabel("ATUALIZE SEU ");
        ...
        JButton btnNewButton = new JButton("Excluir galo");
        btnNewButton.setFont(new Font("Tahoma", Font.BOLD, 17));
        btnNewButton.setBackground(new Color(255, 128, 128));
        btnNewButton.setBounds(523, 558, 245, 53);
